...
class src_finder:
    ...
    def __init__(self,use,fits_filename,map_size,map_resolution,projection_center,detection_kernels_size,n,aperture):
        if use == 'python':
            self.rectmap=create_map.create_map(100,10,7,1.5,1,0.001)
        ...
        self.signal_to_noise_results = sort_signal_to_noise.compute_signal_to_noise_results(self.detection_tools,self.peripheric_std_map,self.detected_src_coor_upper_pixcorner,self.rectmap)
